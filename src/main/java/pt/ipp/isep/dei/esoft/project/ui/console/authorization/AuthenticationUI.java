...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_EMPLOYEE, new OwnerUI()));
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_NETWORK_MANAGER, new NetManagerUI()));
